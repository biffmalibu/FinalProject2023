...
public class UpdatedPrices {
    ...
    private static Date date;                                               // Store the date of the data
    ...
    /*public double convertCurCur(String fromCurrency, String toCurrency, double amount) {
        double convertedAmount = amount * (getPrice("bitcoin", toCurrency) / getPrice("bitcoin", fromCurrency));
